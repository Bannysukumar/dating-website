  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-semibold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 active:scale-95",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-gradient-to-r from-destructive to-red-600 text-white shadow-lg shadow-destructive/25 hover:shadow-destructive/40 hover:-translate-y-0.5",
        outline:
          "border-2 border-white/10 bg-white/5 text-foreground backdrop-blur-sm hover:bg-white/10 hover:border-white/20",
        secondary:
